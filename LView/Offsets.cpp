...
int Offsets::GameTime = 0x2FB0754;
...
int Offsets::ObjSpellBook = 0x2C60;
...
int Offsets::ObjItemList = 0x37F4;

int Offsets::ItemListItem = 0xC;
int Offsets::ItemInfo = 0x20;
int Offsets::ItemInfoId = 0x68;

int Offsets::ViewProjMatrices = 0x02FDBBB0;
int Offsets::Renderer = 0x2FDEA1C;
int Offsets::RendererWidth = 0x0C;
...
int Offsets::ObjectManager = 0x171BBC4;
int Offsets::LocalPlayer = 0x2FB81E8;
int Offsets::UnderMouseObject = 0x2FACDA0;
...
int Offsets::MinimapObject = 0x2FB81EC;
